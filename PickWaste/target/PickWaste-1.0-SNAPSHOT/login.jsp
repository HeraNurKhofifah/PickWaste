<%-- 
    Document   : login
    Created on : Dec 13, 2025, 9:46:23 PM
    Author     : heaaa
--%>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .btn-login:hover { background: #00b850; transform: translateY(-2px); }

        .links-row {
            display: flex; justify-content: space-between; align-items: center;
            margin-top: 15px; font-size: 0.85rem;
        }
        .links-row a { color: #666; text-decoration: none; }
        .links-row a:hover { color: #00d25b; }

        .bottom-text { text-align: center; margin-top: 30px; font-size: 0.9rem; color: #666; }
        ...
        <div class="form-container">
            ...
            <form action="LoginServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="password" name="password" id="passwordInput" class="form-control" placeholder="Masukkan kata sandi Anda" required>
            ...
            <div class="bottom-text">
                Belum punya akun? <a href="register.jsp">Buat Akun</a>
            </div>
